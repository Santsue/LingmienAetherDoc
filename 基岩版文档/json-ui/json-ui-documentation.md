...
| layer                     |         int          |      `0`      | Z-Index/Layer (like z-index in CSS) is relative to the parent element. Higher values render above, while negative values render below the parent element.                                          |
