...
# v2.9.0 Release
## 主要更新
1. 物品选择器现在支持背包物品中的左手内物品及附魔了。![image-QtSj.png](https://lingzhimian.com/upload/image-QtSj.png)
...
## 次要更新
1. 同步了新版本背景盒。![image-OruO.png](https://lingzhimian.com/upload/image-OruO.png)
...
## 主要更新
1. 新增集成功能`军械库核心`面向对象。
   ![image-gVcD.png](https://lingzhimian.com/upload/image-gVcD.png)

2. 新增LAStudio,MTMLan插件架构。
    ![0d0b68fa0ca4eeb441e9b3c03c3efd2c.png](https://lingzhimian.com/upload/0d0b68fa0ca4eeb441e9b3c03c3efd2c.png)
...
2. 新增RegisterOptimizeCustomFeatureRule(服务端)，用于注册优化自定义大型特征规则(用于网易多结构特征生成失败检测的问题)。
  ![image-QyEN.png](https://lingzhimian.com/upload/image-QyEN.png)
...
![QQ20260128-212631.png](https://lingzhimian.com/upload/QQ20260128-212631.png)
...
1. 新增了新版多功能表单控件类型：按钮型输入控件、信息型按钮列表控件、提示控件、下拉菜单框。
  ![image-NJHx.png](https://lingzhimian.com/upload/image-NJHx.png)
...
2. 新增了物品选择器，用于选择物品。
![image-PYqk.png](https://lingzhimian.com/upload/image-PYqk.png)
...
![image-AtyA.png](https://lingzhimian.com/upload/image-AtyA.png)
